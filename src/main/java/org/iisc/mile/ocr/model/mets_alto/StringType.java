...
@XmlType(name = "StringType", namespace = "http://www.loc.gov/standards/alto/ns-v2#", propOrder = {
    "alternative"
})
public class StringType {

    @XmlElement(name = "ALTERNATIVE", namespace = "http://www.loc.gov/standards/alto/ns-v2#")
