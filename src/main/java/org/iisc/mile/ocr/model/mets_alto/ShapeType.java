...
@XmlType(name = "ShapeType", namespace = "http://www.loc.gov/standards/alto/ns-v2#", propOrder = {
    "polygon",
    "ellipse",
    "circle"
})
public class ShapeType {
    ...
    @XmlElement(name = "Polygon", namespace = "http://www.loc.gov/standards/alto/ns-v2#")
    protected PolygonType polygon;
    @XmlElement(name = "Ellipse", namespace = "http://www.loc.gov/standards/alto/ns-v2#")
    protected EllipseType ellipse;
    @XmlElement(name = "Circle", namespace = "http://www.loc.gov/standards/alto/ns-v2#")
