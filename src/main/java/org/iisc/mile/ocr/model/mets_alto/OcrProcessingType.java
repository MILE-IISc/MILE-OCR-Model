...
@XmlType(name = "ocrProcessingType", namespace = "http://www.loc.gov/standards/alto/ns-v2#", propOrder = {
    "preProcessingStep",
    "ocrProcessingStep",
    "postProcessingStep"
})
@XmlSeeAlso({
    org.iisc.mile.ocr.model.mets_alto.Alto.Description.OCRProcessing.class
})
public class OcrProcessingType {
    ...
    @XmlElement(namespace = "http://www.loc.gov/standards/alto/ns-v2#", required = true)
